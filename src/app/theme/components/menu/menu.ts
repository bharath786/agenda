...
export const horizontalMenuItems = [  
    //Parent tabs
    new Menu (1, 'Dashboard', '/dashboard', null, 'looks', null, false, 0),
    // new Menu (2, 'Analytics', null, null, 'timeline', null, true, 0), 
    
    new Menu (4, 'Predictive', '/predictive', null, 'multiline_chart', null, true, 0),  
    new Menu (5, 'System', '/system', null, 'pie_chart', null, true, 0), 
    new Menu (6, 'Control', '/control', null, 'insert_chart', null, true, 0), 
    new Menu (7, 'Process', '/process', null, 'equalizer', null, true, 0), 
    new Menu (3, 'Admin', '/adminsettings', null, 'portrait', null, true, 0),   
    //Sub tabs in Admin
